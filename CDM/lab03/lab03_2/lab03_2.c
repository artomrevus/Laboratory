...
Написати програму, яка реалізує побудову дерева за заданим кодом Прюфера (таблиця 3.2). Етапи розв'язання задачі виводити на екран.
...
- виведення на екран результату виконання програми (ребра побудованого дерева);
